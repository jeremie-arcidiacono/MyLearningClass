 ...
 */
final class Version20230504142020 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE CHAPTER (idChapter INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(200) NOT NULL, videoFilename VARCHAR(30) NOT NULL, videoName VARCHAR(100) NOT NULL, videoDuration INTEGER UNSIGNED NOT NULL, ressourceFilename VARCHAR(30) NOT NULL, updatedAt DATETIME NOT NULL, createdAt DATETIME NOT NULL, idCourse INTEGER UNSIGNED DEFAULT NULL, CONSTRAINT FK_C6C44B34758FC723 FOREIGN KEY (idCourse) REFERENCES COURSE (idCourse) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE COURSE (idCourse INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(200) NOT NULL, description CLOB NOT NULL, imgFilename VARCHAR(30) NOT NULL, visibility VARCHAR(255) NOT NULL, updatedAt DATETIME NOT NULL, createdAt DATETIME NOT NULL, codeCourseCategory INTEGER UNSIGNED DEFAULT NULL, idUser INTEGER UNSIGNED DEFAULT NULL, CONSTRAINT FK_E666A83FDC961AD5 FOREIGN KEY (codeCourseCategory) REFERENCES COURSE_CATEGORY (codeCourseCategory) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_E666A83FFE6E88D7 FOREIGN KEY (idUser) REFERENCES USER (idUser) NOT DEFERRABLE INITIALLY IMMEDIATE)');
